  ...
  const responsiveDrawer = (
    <div style={{ backgroundColor: "#09212E", height: "100%" }}>
      ...
      <List sx={{ backgroundColor: "#09212E" }}>
        ...
        <ListItemButton sx={{ color: "white" }}>
          <ListItemIcon sx={{ color: "white" }}>{<Edit />}</ListItemIcon>
      ...
      <List>
        ...
        <ListItemButton sx={{ color: "white" }}>
          <ListItemIcon sx={{ color: "white" }}>{<PermMedia />}</ListItemIcon>
          <ListItemText primary={"Media"} />
        </ListItemButton>
        <ListItemButton sx={{ color: "white" }}>
          <ListItemIcon sx={{ color: "white" }}>{<Feedback />}</ListItemIcon>
          ...
          >
            <Toolbar>
              ...
              <Typography variant="h6">
                Bienvenue sur le site de Carbon
              </Typography>
            </Toolbar>
          </AppBar>
          <Box
